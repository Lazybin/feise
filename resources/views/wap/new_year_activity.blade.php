...
<section style="position:relative;text-align: center">
    <p id="head" style="position:relative;"  class="img show"><img src="{{url('/')}}/img/first_head.png" alt=""></p>
    <p id="aaaa" class="img base_pos test5 hidden" style="display: none"><img src="{{url('/')}}/img/open_background.png" alt=""></p>
    <p class="img" style="position: absolute;bottom: -145%;">
        <img id="img_box" class=""  style="width:45%" onclick="onOpenClick()" src="{{url('/')}}/img/first_box.png" alt="">
    </p>
...
<script type="text/javascript">
    ...
    function onOpenClick(){
        ...
        $.ajax({
            url: "{{url('/')}}/api/v1/new_year_active",
            async: true,
            type: "POST",
            dataType:'json',
            headers: {
        ...
        document.getElementById("img_box").addEventListener("webkitAnimationEnd",function(e){
            ...
            //alert(111);
            $("#img_box").attr('src','{{url('/')}}/img/box_open.png');
