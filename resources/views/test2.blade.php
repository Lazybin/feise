...
<section style="position:relative;text-align: center">
    ...
    <p class="img" style="position: absolute;bottom: -145%;"><img id="img_box" class=""  style="width:45%" onclick="onOpenClick()" src="img/first_box.png" alt=""></p>
    ...
    <p id="tishi1" style="margin: auto;left:0;right:0;bottom:-175%;position:absolute;"><span class="tishi1">已找到今日宝藏，还有7天，请再接再厉！</span></p>
    <p id="tishi2" style="margin: auto;left:0;right:0;bottom:-190%;position:absolute;"><span class="tishi2">要连续点击七天才能得大礼哦！</span></p>
    <p id="p_thumb" class="img" style="position: absolute;bottom: -200%;"><img class="thumb" onclick="onOpenClick()" style="width:15%" src="img/thumb.png" alt=""></p>
</section>
