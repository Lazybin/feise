...
const SDK_SIGN_CERT_PATH = 'E:/xampp/htdocs/feise/vendor/yinlian_sdk/certs/acp_prod_sign.pfx';
// 签名证书密码
const SDK_SIGN_CERT_PWD = '000000';

// 密码加密证书（这条一般用不到的请随便配）
//const SDK_ENCRYPT_CERT_PATH = 'D:/certs/acp_prod_enc.cer';
const SDK_ENCRYPT_CERT_PATH = 'E:/xampp/htdocs/feise/vendor/yinlian_sdk/certs/acp_prod_enc.cer';
